...
let createCube = () => {
  ...
  let cubeMesh = new THREE.MeshPhongMaterial( { color: 0x4080ff, dithering: true } );
  ...
  cubeBody1.castShadow = true
  cubeBody1.receiveShadow = true
...
let initScene = () => {
 /* const ambientLight = new THREE.AmbientLight(0xffffff, 0.5);
  ...
  let lightFu = new THREE.DirectionalLightHelper(directLight)
